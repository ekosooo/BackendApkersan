                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('kasus.update', $value->kasus_id)}}" method="POST">
                                {{method_field('patch')}}
                                {{csrf_field()}}
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kasus_nama"
                                               value="{{$value->kasus_nama}}">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Deskripsi</label>
                                        <textarea class="form-control" name="kasus_deskripsi" rows="3">{{$value->kasus_deskripsi}}</textarea>
                                    </div>
